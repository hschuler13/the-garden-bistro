  ...
  return (
    <>
      ...
      <div>
        ...
        cozy space where every season brings new flavors to our tables, and
        every meal tells a story of sustainable dining.
      </div>
      <div>Head Chef Asari</div>
      <div>
        {" "}
        ...
        Recommended for: Special occasions, sustainable dining enthusiasts.
      </div>
    </>
  );
}
